    ...
    return (
        ...
        <div className="border-2 border-black lg:border-0 card w-full lg:w-96 h-52 bg-base-100 lg:shadow-xl mb-10 px-20">
            ...
            <div className="card-body flex-row justify-center">
                <h2 className={"card-title  text-black"}>Nokia</h2>
            </div>
            </div>
        </Link>
        ...
        <div className="border-2 border-black lg:border-0  card w-full lg:w-96 h-52 bg-base-100 lg:shadow-xl mb-10 px-20">
            ...
            <div className="card-body ">
                <h2 className="card-title  justify-center text-black">Samsung</h2>
            </div>
            </div>
        </Link>
        ...
        <div className="border-2 border-black lg:border-0  card w-full lg:w-96 h-52 bg-base-100 lg:shadow-xl mb-10 px-20">
            ...
            <div className="card-body ">
                <h2 className="card-title justify-center text-black">Apple</h2>
            </div>
            </div>
        </Link>
        ...
        <div className="border-2 border-black lg:border-0  card w-full lg:w-96 h-52 bg-base-100 lg:shadow-xl mb-10 px-20">
            ...
            <div className="card-body ">
                <h2 className="card-title justify-center text-black">One Plus</h2>
            </div>
            </div>
        </Link>
        ...
        <div className=" border-2 border-black lg:border-0  card w-full lg:w-96 h-52 bg-base-100 lg:shadow-xl mb-10 px-20">
            ...
            <div className="card-body ">
                <h2 className="card-title  justify-center text-black">Oppo</h2>
            </div>
            </div>
        </Link>
        ...
        <div className="border-2 border-black lg:border-0  card w-full lg:w-96 h-52 bg-base-100 lg:shadow-xl mb-10 px-20">
            ...
            <div className="card-body ">
                <h2 className="card-title  justify-center text-black">Xiaomi</h2>
            </div>
            </div>
        </Link>
    </div>
